...
function createRouteAssignmentMessage(event) {
  return {
    type: 'interactive',
...
function createLocationUpdateMessage(event) {
  return {
    type: 'interactive',
...
function createGeofenceEntryMessage(event) {
  return {
    type: 'interactive',
...
const messageTemplates = {
  route_assignment: createRouteAssignmentMessage,
  location_update: createLocationUpdateMessage,
  geofence_entry: createGeofenceEntryMessage
};
    ...
    <script>
        ...
        function showWhatsAppMessage(message) {
            ...
            if (message.type === 'interactive') {
                const buttonsHtml = message.buttons.map(function(btn) {
                    return '<button onclick="handleDriverResponse(\\'' + btn.id + '\\')" ' +
